      ...
      <div class="card-header movie-create-heading">
        <div class="row">
          <div class="col-lg-4 col-4">
            <h5 class="card-title"><?php echo e(__('All Live Events')); ?>
          ...
          <div class="col-lg-8 col-8">
            ...
            data-target=".bd-example-modal-lg" title="<?php echo e(__('Import Live Events')); ?>"><i class="fa fa-file-excel-o mr-2"></i> <?php echo e(__('Import Live Events')); ?> </button>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liveevent.create')): ?>
            <a href="<?php echo e(route('liveevent.create')); ?>" class="float-right btn btn-primary-rgba mb-2 mr-2" title="<?php echo e(__('Add Live Event')); ?>"><i
              ...
              <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                      <div class="modal-header">
                          ...
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close" title="<?php echo e(__('Bulk Import Live Events')); ?>">
                          <span aria-hidden="true">&times;</span>
                          </button>
                      </div>
                          <div class="col-md-12">
                              <div class="card-header">
                                  <a href="<?php echo e(url('files/Liveevents.xlsx')); ?>" class="float-right btn btn-success-rgba mr-2" title="<?php echo e(__('Download Example xls/csv File')); ?>"><i
            ...
            <div class="row">
              ...
              <?php $__currentLoopData = $liveevent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="card">
                      <?php if($src != NULL): ?>
                       <a href="<?php echo e(url('event/detail', $item->slug)); ?>" target="__blank" title="<?php echo e($item->title); ?>"> <img src="<?php echo e($src); ?>" class="card-img-top" alt="<?php echo e($item->title); ?>"></a>
                      <?php endif; ?>
                        ...
                        <div class="dropdown card-dropdown">
                            ...
                            <div class="dropdown-menu pull-right" aria-labelledby="dropdownMenuButton-<?php echo e($item->id); ?>">
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liveevent.view')): ?>
                                <a class="dropdown-item" href="<?php echo e(url('event/detail', $item->slug)); ?>" target="__blank" title="<?php echo e(__('Preview')); ?>"><i class="feather icon-monitor mr-2"></i><?php echo e(__('Preview')); ?></a>        
                              <?php endif; ?>
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liveevent.edit')): ?>                                
                                <a class="dropdown-item" href="<?php echo e(route('liveevent.edit', $item->id)); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i> <?php echo e(__('Edit')); ?></a>     
                              <?php endif; ?>
                              <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('liveevent.delete')): ?>                                 
                        ...
                        <div class="card-header">
                          <a href="<?php echo e(url('event/detail', $item->slug)); ?>" target="__blank" title="<?php echo e($item->title); ?>"><h5 class="card-title"><?php echo e($item->title); ?></h5></a>
                        </div>
                        <div class="card-body">
              ...
              <?php else: ?>
                <div class="col-md-12 text-center">
                  ...
                  <small><?php echo e(__('Get Started by creating a liveevent ! All of your live events will be displayed on this page.')); ?></small>
                </div>
              <?php endif; ?>
            </div>
        </section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/oxs.in/halkut.oxs.in/resources/views/admin/liveevent/index.blade.php ENDPATH**/ ?>